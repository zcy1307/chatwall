    ...
    return function e(t, n, r) {
                    ...
                    if ("opening" == this.readyState || "open" == this.readyState) {
                        ...
                        if (this.writeBuffer.length) {
                            this.once("drain", function() {
                                if (this.upgrading) { waitForUpgrade() } else { close() }
                            })
                        } else if (this.upgrading) { waitForUpgrade() } else { close() }
                    }
            ...
            (function(global) {
                ...
                Request.prototype.create = function() {
                    ...
                    try {
                        ...
                        try {
                            if (this.extraHeaders) {
                                ...
                                for (var i in this.extraHeaders) {
                                    if (this.extraHeaders.hasOwnProperty(i)) { xhr.setRequestHeader(i, this.extraHeaders[i]) }
                                }
                            }
                        } catch (e) {}
                        ...
                        if ("POST" == this.method) {
                            try {
                                if (this.isBinary) { xhr.setRequestHeader("Content-type", "application/octet-stream") } else { xhr.setRequestHeader("Content-type", "text/plain;charset=UTF-8") }
                            } catch (e) {}
                        }
                    ...
                    for (var i = 0, l = total; i < l; i++) {
                        (function(packet) {
                            parser.encodePacket(packet, self.supportsBinary, function(data) {
                                ...
                                try {
                                    if (BrowserWebSocket) { self.ws.send(data) } else { self.ws.send(data, opts) }
                                } catch (e) { debug("websocket closed before onclose event") }--total || done()
                            })
                        })(packets[i])
                    }
        ...
        17: [function(_dereq_, module, exports) {
            ...
            function save(namespaces) {
                try {
                    if (null == namespaces) { exports.storage.removeItem("debug") } else { exports.storage.debug = namespaces }
                } catch (e) {}
            }
                                        ...
                                        try {
                                            if (parse("0") === 0 && !parse(false)) {
                                                ...
                                                if (parseSupported) {
                                                    ...
                                                    if (parseSupported) {
                                                        try { parseSupported = parse("1.") !== 1 } catch (exception) {}
                                                    }
                                                }
                                            }
                                        } catch (exception) { parseSupported = false }
                                    }
                            ...
                            if (!has("json-stringify")) {
                                ...
                                exports.stringify = function(source, filter, width) {
                                    ...
                                    if (objectTypes[typeof filter] && filter) {
                                        if ((className = getClass.call(filter)) == functionClass) { callback = filter } else if (className == arrayClass) {
                                            properties = {};
                            ...
                            if (!has("json-parse")) {
                                ...
                                var walk = function(source, property, callback) {
                                    ...
                                    if (typeof value == "object" && value) {
                                        ...
                                        } else { forEach(value, function(property) { update(value, property, callback) }) }
                                    }
